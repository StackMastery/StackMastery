  ...
  return (
    <>
      <Terminal>
        ...
        <AnimatedSpan delay={1000} className="text-cyan-500 underline">
          <a href="https://github.com/stackmastery">GitHub</a>
        </AnimatedSpan>
        <AnimatedSpan delay={1000} className="text-cyan-500 underline">
          <a href="mailto:labib.developers@gmail.com">
            ✉ labib.developers@gmail.com
          </a>
        </AnimatedSpan>
        <AnimatedSpan delay={1000} className="text-cyan-500 underline">
          <a href="tell:+880 176 239 5985">🕻 +880 176 239 5985</a>
        </AnimatedSpan>
      </Terminal>
    </>
  );
